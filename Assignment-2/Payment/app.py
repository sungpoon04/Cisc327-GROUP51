...
def validate_payment(method, card_number, expiration, name, country):
...
def process_payment():
    ...
    expiration = request.form['expiration'].replace("/", "")
    cvc = request.form['cvc']
    name_on_card = request.form['name_on_card'].replace(" ", "")
    country = request.form['country']

    # Validate payment details against the mock database
    balance = validate_payment(method, card_number, expiration, name_on_card, country)
